...
CREATE ROLE IF NOT EXISTS babytracker WITH LOGIN ENCRYPTED PASSWORD '{{ babytracker_db_password | default("change_me_replace") }}';
CREATE DATABASE IF NOT EXISTS babytracker OWNER babytracker;
...
CREATE ROLE IF NOT EXISTS babytracker_test WITH LOGIN ENCRYPTED PASSWORD '{{ babytracker_test_db_password | default("change_me_replace") }}';
CREATE DATABASE IF NOT EXISTS babytracker_test OWNER babytracker_test;
GRANT ALL PRIVILEGES ON DATABASE babytracker_test TO babytracker_test;

CREATE ROLE IF NOT EXISTS babytracker_prod WITH LOGIN ENCRYPTED PASSWORD '{{ babytracker_prod_db_password | default("change_me_replace") }}';
CREATE DATABASE IF NOT EXISTS babytracker_prod OWNER babytracker_prod;
